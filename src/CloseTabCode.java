...
/**   *   * @author Herkules   */  
public class CloseTabCode implements Icon
		{  
	private final Icon mIcon; 
private JTabbedPane mTabbedPane = null; 
private transient Rectangle mPosition = null;  
/**  * Creates a new instance of TabCloseIcon.  */  
		public CloseTabCode( Icon icon )  { 
				mIcon = icon;
	}    
/**  * Creates a new instance of TabCloseIcon.  */ 
		public CloseTabCode()  {
			this( new ImageIcon( CloseTabCode.class.getResource("/resources/icon/closeTab.gif")) );
		...
		public void paintIcon(Component c, Graphics g, int x, int y)  {  
			...
			{  
				...
				{  
					final int index = mTabbedPane.getSelectedIndex();  mTabbedPane.remove( index ); 
					e.consume(); 
					} 
				} 
			}); 
