...
import bo.html.Formatter.Util.FormatParserContext.Command;
...
public class ParserContext extends Object {
    ...
    private void endIteration() {
        ...
        bo.swift.Formatter.FormatterIterator iter = FormatterParser.getIterator(_iterator);
        ...
        if (iter == null) {
            ...
            while (iter.hasNext()) {
                ...
                FormatterParser.doKeywordSubstitution();
            }
        }
        _iterating = false;
        _iterator = null;
    ...
    private void execute(Command command) {
        ...
        if (instruction == INCLUDE) {
            pushStack();
            FormatterParser.parseInclude((String) arguments.elementAt(0));
            popStack();
            ...
            b.append(str);
            FormatterParser.addLine(b.toString());
        } else if (instruction == SET) {
            Object identifier = arguments.elementAt(0);
            Object value = arguments.elementAt(1);
            FormatterParser.setKeywordValue(identifier, value);
        }
    }
