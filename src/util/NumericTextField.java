...
public class NumericTextField extends JTextField implements
  ...
  public String getText(int decimal) {
	  String text = super.getText();
	  text = checkAmount(text,decimal);
	 double dd =  NumberFormatUtil.stringToNumber(text, Locale.getDefault());
	  return String.valueOf(dd);
  }
  public String getText( ) {
	  String text = super.getText();
	  text = checkAmount(text,6);
	 double dd =  NumberFormatUtil.stringToNumber(text, Locale.getDefault());
	  return String.valueOf(dd);
  }
  ...
  static public String checkAmount(String s,int decimal) {
      return checkAmount(s, decimal,false);
  }
