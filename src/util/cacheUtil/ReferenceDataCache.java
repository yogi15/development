...
public class ReferenceDataCache extends BaseCache {
	...
	private static void cacheLeContacts() {
		...
		while (enu.hasMoreElements()) {
			...
			try {
				Vector<LeContacts> leContacts = (Vector) remoteBORef
						.getLeContacts(le.getId());
	...
	private static void cacheBooks(Vector books,
			Hashtable<Integer, Book> bookCache2) {
		// TODO Auto-generated method stub
	...
	public static Vector<Sdi> getSdisonLegelEntityRole(String role, int leID,
			String currency, String productType) {
			...
			if (sdi.getRole().equalsIgnoreCase(role)) {
				...
				if (pType && curr) {
					...
					continue;
						...
						&& sdi.getCurrency().equalsIgnoreCase(SDIConstants.ANY)) {
					sdifound.add(sdi);
					pType = false;
					curr = false;
					continue;
						...
						&& sdi.getProducts().equalsIgnoreCase(SDIConstants.ANY)) {
					sdifound.add(sdi);
					pType = false;
					curr = false;
					continue;

				} else if (sdi.getCurrency().equalsIgnoreCase(SDIConstants.ANY)
						&& sdi.getProducts().equalsIgnoreCase(SDIConstants.ANY)) {
					sdifound.add(sdi);
	...
	public static Vector<Sdi> getSdisonLegelEntityRole(String role, int leID,
			String currency, String messageType, String productType) {
		Vector<Sdi> sdis = getSdi(leID);
		Vector<Sdi> sdifound = new Vector<Sdi>();
	...
	public static String getAttribute(int poid, int cpid, String attributeType,
			String cpRole) {
		return null;
	}
	...
	public static WindowSheet saveWindowSheet(WindowSheet windowSheet) {
		...
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("RemoteRefernceDataCache",
					"saveWindowSheet", e);
			return null;
		}
	}
	...
	public static Vector<WindowSheet> selectWindowSheets(String windowName,
		...
		try {
			if (singleTonInstance == null)
				singleTonInstance = getSingleInstatnce();
			windowSheet = (Vector<WindowSheet>) remoteBORef.selectWindowSheet(
					windowName, designType);
			return windowSheet;
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			commonUTIL.displayError("RemoteRefernceDataCache",
					"selectWindowSheets", e);
			return null;
		}
	}
	...
	public static Vector<WindowSheet> selectWindowSheets(String windowName) {
		...
		try {
			if (singleTonInstance == null)
				singleTonInstance = getSingleInstatnce();
			windowSheet = (Vector<WindowSheet>) remoteBORef
					.selectWindowSheet(windowName);
			return windowSheet;
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			commonUTIL.displayError("RemoteRefernceDataCache",
	...
	public static Vector<WindowSheet> getWindowSheet(WindowSheet windowSheet) {
		...
		try {
			if (singleTonInstance == null)
				singleTonInstance = getSingleInstatnce();
			return (Vector<WindowSheet>) remoteBORef.selectWindowSheet(
					windowSheet.getWindowName(), windowSheet.getFieldName());
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			commonUTIL.displayError("RemoteRefernceDataCache",
					"getWindowSheet", e);
	...
	public static boolean deleteWindowTableModelMapping(
		...
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("RemoteRefernceDataCache",
					"updateWindowTableModelMapping", e);
			return false;
		}
	}
	...
	public static Vector<WindowTableModelMapping> selectWindowTableModelMappings(
		...
		// TODO Auto-generated method stub
		try {
			Vector<WindowTableModelMapping> tableModels = (Vector<WindowTableModelMapping>) remoteBORef
					.selectWindowTableModel(searchText);
			return tableModels;
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			commonUTIL.displayError("RemoteRefernceDataCache",
					"selectWindowTableModelMappings", e);
			return null;
		}
	...
	public static BaseBean insertSQL(BaseBean bean, String beanName) {
		...
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache", "insertSQL error "
					+ beanName, e);
			return null;
		}
	}
	...
	public static boolean updateSQL(BaseBean bean, String beanName) {
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache", "updateSQL error "
					+ beanName, e);
			return false;
		}
	}
	...
	public static boolean deleteSQL(BaseBean bean, String beanName) {
		...
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache", "deleteSQL error "
					+ beanName, e);
			return false;
		}
	}
	...
	public static BaseBean select(int id, String beanName) {
		...
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache", "select error "
					+ beanName, e);
			return null;
		}
	}
	...
	public static Collection selectWhere(String where, String beanName) {
		...
		try {
			...
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache", "selectWhere error "
					+ beanName, e);
			return null;
		}
	}
	...
	public static Collection selectKeyColumnsWithWhere(String columnNames,
			String where, String beanName) {
		// TODO Auto-generated method stub
		try {
			return remoteBORef.selectKeyColumnsWithWhere(columnNames, where,
					beanName);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache",
					"selectKeyColumnsWithWhere error " + beanName, e);
			return null;
		}
	}
	...
	public static Collection selectKeyColumns(String columnNames,
		...
		// TODO Auto-generated method stub
		try {
			return remoteBORef.selectKeyColumns(columnNames, beanName);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			commonUTIL.displayError("ReferenceDataCache",
