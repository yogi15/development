...
public class TestingSampleProperty extends JFrame {
	...
	String windowName = "";
	public TestingSampleProperty(List<Property> prop,String windowName) {
		this.prop = prop;
	...
	private void createSampleTestPropertyTables() {
		...
		JPanel propertyTablePanel = getSamplePropertyTablePanel(prop);
		
		jPanel0.add( propertyTablePanel, BorderLayout.CENTER);
		jPanel0.add(button, BorderLayout.SOUTH);
	}
	 private JPanel getSamplePropertyTablePanel(List<Property> prop) {
			// TODO Auto-generated method stub
			 propertyTable = new SampleTestPropertyTable(SamplesTestContant.SAMPLETEST).getSampleTestPropertyTable(prop,windowName);
