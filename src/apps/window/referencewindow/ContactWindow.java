...
public class ContactWindow extends BasePanel {
	...
	Vector<LeContacts> rightPanelJtableContactdata = new Vector<LeContacts>(); // used
																				// maintain
																				// data
																				// in
																				// rightPanel
	...
	/**
	 * @return the data / public Vector<LeContacts> getData() { return
	 *         rightPanelJtableContactdata; } /**
	 * @param data
	 *            the data to set
	 */
	...
	public final JTextField contactSearchTextField = new JTextField("LeContactsTextField", 15); // search
																								// textfield
																								// in
																								// leftTopPanel
																								// Data
	...
	public JPanel createChildPanel(int parentID) {
		...
		windowUtil.loadData(parentID); // setting data in Model for all details
										// record of parent id.
		rightSideCenterTable.setModel(model); // rightSideCenterTable is used to
												// show all details records of
												// Parent id.
