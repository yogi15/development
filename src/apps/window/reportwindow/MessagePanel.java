...
public class MessagePanel extends ReportPanel {
	
	
	 String mainsql = " SELECT messagetype FROM message message";
	 String mainSQLKey = "Message message"; 
	...
	public JPanel loadreport() {
		jPanel1  = getDemo().run();
	     ...
	     DatePanel datep = new DatePanel("Message");
