...
import beans.HelperRepoBean;
import beans.Trade;import dsServices.RemoteProduct;
   	 ...
   	 RemoteProduct remoteproduct= null;
		 ...
		 Properties prop = new Properties();
			...
			prop.load(Thread.currentThread().getContextClassLoader()
			  ...
			  String path  = prop.getProperty("pathRepoFile");
			 java.util.Vector<Deal> beans =  CSVFileHandler.read(path ,new HelperRepoBean());
				for(int i=0;i<beans.size();i++) {
				Trade trade = dealSender.buildRepoTrade((Deal)beans.get(i));
