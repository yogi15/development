...
public class MMCompounding extends MMAmortization {
	...
	public MMCompounding(double tradeAmount, Coupon coupon) {

	/*	this.trade = trade;*/
		this.coupon = coupon;

		this.tradeAmount = tradeAmount;
		this.daycount = CountDay.valueOf(coupon.getDayCount());
