...
public class XTableColumnModel extends DefaultTableColumnModel {
    ...
    public Vector<String> LTableColumns            = new Vector<String>();
    Hashtable<String,TableColumn> unVisiableColumns = new  Hashtable<String,TableColumn>();
    Hashtable<String,TableColumn> visiableColumns = new  Hashtable<String,TableColumn>();
    
    /**
	 * @return the lTableColumns
	 */
	public Vector<String> getLTableColumns() {
		return LTableColumns;
	}

	/**
	 * @param lTableColumns the lTableColumns to set
	 */
	public void setLTableColumns(Vector<String> lTableColumns) {
		LTableColumns = lTableColumns;
	}

	/**
	 * @return the rTableColumns
	 */
	public Vector<String> getRTableColumns() {
		return RTableColumns;
	}

	/**
	 * @param rTableColumns the rTableColumns to set
	 */
	public void setRTableColumns(Vector rTableColumns) {
		RTableColumns = rTableColumns;
	}

	public Vector<String> RTableColumns            = new Vector<String>();
 ...
 */
    ...
    public Vector<String> getUnVisibleColumn() {
    	Vector<String> unVis = new Vector<String>();
    	Enumeration<String> keys = unVisiableColumns.keys();
    	 while(keys.hasMoreElements()) {
    		 String kye = keys.nextElement();
    		 unVis.add(kye);
    		 
    	 }
    	return unVis;
    }
    public int getColumnIndexOnName(String colName) {
		// TODO Auto-generated method stub
    	Enumeration<TableColumn> columns = allTableColumns.elements();
		int i = -1;
		int index = 0;
    ...
    public int getColumnIndexOnName(String colName,int setIndex) {
		// TODO Auto-generated method stub
    	Enumeration<TableColumn> columns = allTableColumns.elements();
		int i = -1;
		int index = 0;
    ...
    public void removeUnVisibleColumns(String columnName) {
    	if(unVisiableColumns.containsKey(columnName)) 
    		unVisiableColumns.remove(columnName);
    }
    public void setColumnVisible(TableColumn column, boolean visible) {
        if(!visible) {
            super.removeColumn(column);
            unVisiableColumns.put((String) column.getHeaderValue(), column );
        }
        else {
            ...
            // visible columns up to the one that's about to be shown again
        	 if(unVisiableColumns.containsKey((String) column.getHeaderValue()) )
        		 unVisiableColumns.remove((String) column.getHeaderValue());
 ...
 */    
	...
	public void clearUnVisableColumns() {
		// TODO Auto-generated method stub
		unVisiableColumns.clear();
