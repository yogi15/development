...
public class Coupon implements BaseBean {
	...
	public String getPERIODADJUSTED() {
		return PERIODADJUSTED;
	}

	public void setPERIODADJUSTED(String pERIODADJUSTED) {
		PERIODADJUSTED = pERIODADJUSTED;
	}

	public String getPAYDAYLAG() {
		return PAYDAYLAG;
	}

	public void setPAYDAYLAG(String pAYDAYLAG) {
		PAYDAYLAG = pAYDAYLAG;
	}
